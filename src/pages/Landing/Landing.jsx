                ...
                <div className="flex flex-col items-start gap-5 w-[20vw]">
                    ...
                    <div className="flex flex-row gap-5">
                        <ButtonDynamicColor
                            ...
                            color={demoColors.mainBrand}></ButtonDynamicColor>
                        <ButtonDynamicColor
                            link="/Picker"
                ...
                <div className="grid grid-rows-2 grid-cols-2 w-[40vw] gap-24">
                    <div className="flex flex-col gap-3">
                        ...
                        <p
                            className="subtext"
                            style={convertStyle(demoColors.lightAccent)}>
                            Removes the hassle of changing colours on your own
                            design, simple preview them using this website
                        </p>
                    </div>
                    <div className="flex flex-col gap-3">
                        <svg
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p
                            className="subtext"
                            style={convertStyle(demoColors.lightAccent)}>Checkout my other projects on my <a className="underline">Github</a> or my <a className="underline">personal website</a>.</p>
                    </div>
                </div>
            </section>
        </>
