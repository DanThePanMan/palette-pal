function PaletteDemoButton(props) {
    ...
    return (
        <button onClick={stateChangehandler}  className="flex flex-row h-16 w-16 xl:h-20 xl:w-20 border-2 border-neutral-400 box-content rounded-2xl transition-all ease-in-out overflow-clip">
