function HeaderDropdown(props){
    ...
    return(
    <div >
            <ul className="relative w-54 h-fit flex flex-col border bg-[#2D2D2D] z-50 bottom-4 rounded-sm left-[36vw] xl:left-[27vw] top-24 p-8 gap-4 mt-20" onMouseEnter={() => {console.log("test")}} onMouseLeave={() => closeDropdown()}>
